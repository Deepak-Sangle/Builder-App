  ...
  return (
    <View style={styles.navigationView}>
      <TouchableOpacity
        ...
        onPressOut={() => navigation.navigate('DashBoardView', {access: true})}>
      ...
      <TouchableOpacity
        activeOpacity={0.7}
        style={styles.iconView}
        onPressOut={() => navigation.navigate('BroadcastView')}>
        <CustomIcons
          name="broadcast-mainnav-active"
          color="#0078E9"
          size={30}
        />
      ...
      <TouchableOpacity
        activeOpacity={0.7}
        style={styles.iconView}
        onPressOut={() => navigation.navigate('BuildersView')}>
        <MaterialIcons
          name="apartment"
      ...
      <TouchableOpacity
        activeOpacity={0.7}
        style={styles.iconView}
        onPressOut={() => navigation.navigate('MyClient')}>
        <AwesomeIcons
          name="clipboard-list"
          style={styles.iconStyle}
          color="#0078E9"
      ...
      <TouchableOpacity
        activeOpacity={0.7}
        style={styles.iconView}
        onPressOut={() => navigation.navigate('MenuScreen')}>
        <EntypoIcons
