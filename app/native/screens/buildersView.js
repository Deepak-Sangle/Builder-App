...
const BuildersView = ({navigation}) => {
  ...
  const [company, setCompany] = useState([
    {
      image_url: require('../../../android/app/src/main/assets/images/temp_images/Bitmap-1.png'),
      num_of_projects: 18,
      id: 1,
      isTag: true,
    },
    {
      image_url: require('../../../android/app/src/main/assets/images/temp_images/Bitmap-2.png'),
      num_of_projects: 12,
      id: 2,
      isTag: false,
    },
    {
      image_url: require('../../../android/app/src/main/assets/images/temp_images/Bitmap-3.png'),
      num_of_projects: 12,
      id: 3,
      isTag: false,
    },
    {
      image_url: require('../../../android/app/src/main/assets/images/temp_images/Bitmap-4.png'),
      num_of_projects: 18,
      id: 4,
      isTag: true,
    },
    {
      image_url: require('../../../android/app/src/main/assets/images/temp_images/Bitmap-5.png'),
      num_of_projects: 12,
      id: 5,
      isTag: false,
    },
      ...
      <View style={styles.allBuildersView}>
        {data.map((val, index) => {
          ...
          return (
            <TouchableOpacity
              activeOpacity={1}
              onPressOut={() => setSelectedTab(index)}
              key={val.id}
              style={styles.buildercomplete}>
              <View style={[styles.eachbuilderView, BoxStyle]}>
                <Text
                  style={[
                    styles.textStyle,
                    styles.builderText,
                    {color: selectedTab === index ? '#FFFFFF' : '#545454'},
                  ]}>
                  {val.title}
                </Text>
    ...
    <View style={{flex: 1}}>
      <ScrollView>
        ...
        <View style={styles.searchBarView}>
          <CustomSearchBar
            text="Search builders or project"
