...
const CompleteProfileView = ({navigation}) => {
  const companyType = useSelector(state => state.walkInScreen.companyTypeDD);
  const statesDD = useSelector(state => state.walkInScreen.stateDD);
  ...
  const [stateList, setStateList] = useState(statesDD);
      ...
      <View style={styles.mainView}>
        <View style={[styles.container]}>
          ...
          <Text style={styles.describtion}>
            Completed profile helps you get connected to builders faster.
          </Text>
        </View>
        <View style={styles.container}>
          ...
          <View style={styles.inputView}>
            <Text style={[styles.textStyle, styles.label]}>
              Company address
            </Text>
            <View>
              <Controller
          ...
          <View style={styles.inputView}>
            <Text style={[styles.textStyle, styles.label]}>
              ...
              <Text style={{color: '#A6A6A6'}}>(Optional)</Text>
            </Text>
